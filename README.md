...
A JSON PATCH operation (partial update) is also supported whose JSON is defined by [RFC (Request For Comments) 6902](https://datatracker.ietf.org/doc/html/rfc6902). The [zjsonpatch](https://github.com/flipkart-incubator/zjsonpatch) API implements the RFC and is used in the project to initiate partial updates when consuming and producing JSON. Consult the [RFC](https://datatracker.ietf.org/doc/html/rfc6902) to learn more about creating the proper JSON for partial updates.
